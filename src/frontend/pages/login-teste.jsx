                ...
                <div className='flex flex-col items-center w-1/3 mr-40 rounded-xl'>
                    ...
                    <div className='flex flex-col justify-center items-center gap-8 mt-8'>
                        ...
                        <div className='flex flex-row'>
                            ...
                            <input type="text" className={styles.input} placeholder="Email" onChange={e => setEmail(e.target.value)}></input>                        </div>
                        <div className='flex flex-row mb-6'>
                            <img src='/key-solid.svg' className='w-6 absolute mt-3 ml-2'></img>
                            <input type="password" className={styles.input} placeholder="Senha" onChange={e => setPassword(e.target.value)}></input>
                        </div>
