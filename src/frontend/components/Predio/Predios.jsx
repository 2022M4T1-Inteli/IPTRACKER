...
function Predio({ }) {
    ...
    return (
        ...
        <div className='flex justify-center'>
            <div className='grid  lg:grid-cols-3 lg:gap-20 md:grid-cols-1 justify-items-center lg:w-110 md:w-100 p-5'>
                {mock.map((element) => (
                    <div className='flex flex-col rounded-lg border-2 border-black w-80 shadow-md shadow-black mb-6'>
                        ...
                        <div className='flex justify-center'>
                            <Link href="/salas">
                                <button className="bg-green-500 rounded-lg mt-4  mb-4 p-2 hover:bg-green-400">Ver detalhes</button>
                            </Link>
                        </div>
                    </div>
